...
let focalLength = 12;
let painter = new Painter(document.querySelector('canvas.Archimedean-4-6-A-to-3-4-5-4'), vLight, focalLength);
let lineWidth = 3;
...
let vertexB1 = new VectorPoint(1 / (kA + 2), kA, 2 / (kA + 2));
let vertexC1 = new VectorPoint(0, (kA * 2 + 1) / (kA + 2), kA);
let vertexD1 = new VectorPoint(1 / (kA * 2 + 3), 1 / (kA * 2 + 3), 1);
