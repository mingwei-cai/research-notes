...
let vertexA = new Point(+ 2, + kC * 2, + kD * 2);
let vertexB = new Point(+ kC * (kA + 1) - kD + kA, + kC + kD * kA - (kA + 1), + kC * kA + kD * (kA + 1) + 1);
let vertexC = new Point(+ kC - kD * kA - (kA + 1), - kC * kA + kD * (kA + 1) - 1, + kC * (kA + 1) + kD + kA);
let vertexD = new Point(- kC + kD * kA - (kA + 1), - kC * kA + kD * (kA + 1) + 1, + kC * (kA + 1) + kD - kA);
let vertexE = new Point(- kC * (kA + 1) + kD + kA, + kC + kD * kA + (kA + 1), + kC * kA + kD * (kA + 1) - 1);
