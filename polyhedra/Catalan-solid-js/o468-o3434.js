...
let focalLength = 12;
let painter = new Painter(document.querySelector('canvas.Catalan-o468-o3434'), vLight, focalLength);
let lineWidth = 3;
...
let solidA = new Polyhedron([
	...
	faceA.Map(Point.listSymmetry[0o10], colorB),
	faceA.Map(Point.listSymmetry[0o11], colorB),
	faceA.Map(Point.listSymmetry[0o12], colorB),
	faceA.Map(Point.listSymmetry[0o13], colorB),
	faceA.Map(Point.listSymmetry[0o14], colorB),
	faceA.Map(Point.listSymmetry[0o15], colorB),
	faceA.Map(Point.listSymmetry[0o16], colorB),
	...
	faceA.Map(Point.listSymmetry[0o30], colorC),
	faceA.Map(Point.listSymmetry[0o31], colorC),
	faceA.Map(Point.listSymmetry[0o32], colorC),
	faceA.Map(Point.listSymmetry[0o33], colorC),
	faceA.Map(Point.listSymmetry[0o34], colorC),
	faceA.Map(Point.listSymmetry[0o35], colorC),
	faceA.Map(Point.listSymmetry[0o36], colorC),
	...
	faceA.Map(Point.listSymmetry[0o50], colorA),
	faceA.Map(Point.listSymmetry[0o51], colorA),
	faceA.Map(Point.listSymmetry[0o52], colorA),
	faceA.Map(Point.listSymmetry[0o53], colorA),
	faceA.Map(Point.listSymmetry[0o54], colorA),
	faceA.Map(Point.listSymmetry[0o55], colorA),
	faceA.Map(Point.listSymmetry[0o56], colorA),
