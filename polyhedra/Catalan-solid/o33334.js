...
let focalLength = 12;
let painter = new Painter(document.querySelector('canvas.Catalan-o33334'), vLight, focalLength);
let lineWidth = 3;
...
let faceA = new Polygon([
	...
	dualC.Map(Point.listSymmetry[0o40]),
	dualC.Map(Point.listSymmetry[0o12]),
], 0, colorA);
